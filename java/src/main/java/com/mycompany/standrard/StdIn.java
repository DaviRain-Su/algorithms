...
public final class StdIn {
    ...
    public static String[] readAllStrings() {
        ...
        for (int i = 0; i < tokens.length - 1; i++) decapitokens[i] = tokens[i +
            1];
        return decapitokens;
    }
    ...
    public static int[] readAllInts() {
        ...
        for (int i = 0; i < fields.length; i++) vals[i] = Integer.parseInt(
            fields[i]
        );
        return vals;
    }
    ...
    public static long[] readAllLongs() {
        ...
        for (int i = 0; i < fields.length; i++) vals[i] = Long.parseLong(
            fields[i]
        );
        return vals;
    }
    ...
    public static double[] readAllDoubles() {
        ...
        for (int i = 0; i < fields.length; i++) vals[i] = Double.parseDouble(
            fields[i]
        );
        return vals;
    }
