...
public final class BinaryOut {
    ...
    public BinaryOut(String filename) {
        ...
        if (filename.length() == 0) {
            throw new IllegalArgumentException(
                "filename argument is the empty string"
            );
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(
                "could not create file '" + filename + "' for writing",
                e
            );
        }
    }
    ...
    public BinaryOut(Socket socket) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                "could not create output stream from socket",
                e
            );
        }
    }
    ...
    public void write(int x, int r) {
        ...
        if (r < 1 || r > 32) throw new IllegalArgumentException(
            "Illegal value for r = " + r
        );
        if (x >= (1 << r)) throw new IllegalArgumentException(
            "Illegal " + r + "-bit char = " + x
        );
        for (int i = 0; i < r; i++) {
    ...
    public void write(char x) {
        if (x >= 256) throw new IllegalArgumentException(
            "Illegal 8-bit char = " + x
        );
        writeByte(x);
    }
    ...
    public void write(char x, int r) {
        ...
        if (r < 1 || r > 16) throw new IllegalArgumentException(
            "Illegal value for r = " + r
        );
        if (x >= (1 << r)) throw new IllegalArgumentException(
            "Illegal " + r + "-bit char = " + x
