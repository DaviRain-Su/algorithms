...
public final class StdAudio {
    ...
    private static AudioInputStream getAudioInputStreamFromFile(
        ...
        try {
            ...
            InputStream is2 =
                StdAudio.class.getClassLoader().getResourceAsStream(filename);
            if (is2 != null) {
...
*/
    ...
    public static void play(double sample) {
        if (Double.isNaN(sample)) throw new IllegalArgumentException(
            "sample is NaN"
        );
    ...
    public static void play(String filename) {
        ...
        if (isRecording) {
            ...
            for (double sample : samples) recordedSamples.enqueue(sample);
        }
